...
APPS=( 'python3' 'golang' 'Caskroom/cask/java' 'scala' 'sbt' \
  'coreutils --with-default-names' 'findutils --with-default-names' 'tree' 'httpie' 'git' 'Caskroom/cask/shiftit' \
  ...
  'Caskroom/cask/transmission' 'Caskroom/cask/google-chrome' 'caskroom/cask/insomnia' 'bash' )
